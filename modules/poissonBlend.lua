...
return function(env)
	...
	local function getGradient(x1, y1, x2, y2, r, g, b, a)
		...
		r = ((a1.r - a2.r) * m + (b1.r - b2.r) * (1 - m)) / 255 + r
		g = ((a1.g - a2.g) * m + (b1.g - b2.g) * (1 - m)) / 255 + g
		b = ((a1.b - a2.b) * m + (b1.b - b2.b) * (1 - m)) / 255 + b
		a = ((a1.a - a2.a) * m + (b1.a - b2.a) * (1 - m)) / 255 + a
